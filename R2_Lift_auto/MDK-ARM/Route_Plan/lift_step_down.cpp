...
float STEP_DOWN_AUTO_CHASSIS_SPEED_MPS = 2.2f;
...
float STEP_DOWN_PREPARE_DISTANCE_L = 0.30f;
// 下 200 台阶下降阶段离开当前坐标的距离，单位为 m。
float STEP_DOWN_DESCEND_DISTANCE_200_D = 0.61f;
// 下 400 台阶下降阶段离开当前坐标的距离，单位为 m。
float STEP_DOWN_DESCEND_DISTANCE_400_D = 0.53f;
